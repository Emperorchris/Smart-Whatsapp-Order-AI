...
class Message(Base):
    ...
    direction = Column(String, nullable=False, default=utils.MessageDirection.INBOUND.value)
    message_type = Column(String, nullable=False, default=utils.MessageType.TEXT.value)
    content = Column(Text)
