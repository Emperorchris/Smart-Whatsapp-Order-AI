...
async def create_conversation(conversation_data: conversation_schema.ConversationSchema, db: DBSession):
...
async def get_all_conversations(db: DBSession):
...
async def get_conversations_by_customer(customer_id: str, db: DBSession):
...
async def update_conversation(conversation_id: str, conversation_data: conversation_schema.ConversationSchema, db: DBSession):
...
async def resume_ai(conversation_id: str, db: DBSession, 
                    # _: CurrentStaff
                    ):
