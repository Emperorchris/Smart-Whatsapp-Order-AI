...
async def create_staff(data: staff_schema.StaffCreate, db: DBSession):
...
async def get_all_staff(db: DBSession, _: AdminOnly):
...
async def update_staff(staff_id: str, data: staff_schema.StaffUpdate, db: DBSession, _: AdminOnly):
...
async def delete_staff(staff_id: str, db: DBSession, _: AdminOnly):
