...
async def create_message(message_data: message_schema.MessageSchema, db: DBSession):
...
async def get_message(message_id: str, db: DBSession):
...
async def get_messages_by_conversation(conversation_id: str, db: DBSession):
...
async def get_message_by_whatsapp_id(whatsapp_message_id: str, db: DBSession):
...
async def delete_message(message_id: str, db: DBSession):
