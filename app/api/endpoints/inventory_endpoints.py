...
async def create_inventory(inventory_data: inventory_schema.InventorySchema, db: DBSession):
...
async def get_all_inventory(db: DBSession):
...
async def get_inventory(inventory_id: str, db: DBSession):
...
async def get_inventory_by_product(product_id: str, db: DBSession):
...
async def update_inventory(inventory_id: str, inventory_data: inventory_schema.InventorySchema, db: DBSession):
...
async def delete_inventory(inventory_id: str, db: DBSession):
