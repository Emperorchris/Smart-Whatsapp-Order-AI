...
async def get_order_by_number(order_number: str, db: DBSession):
...
async def get_orders_by_customer(customer_id: str, db: DBSession):
...
async def delete_order(order_id: str, db: DBSession):
...
async def create_order_item(order_id: str, order_item_data: order_item_schema.OrderItemSchema, db: DBSession):
...
async def get_order_items(order_id: str, db: DBSession):
...
async def get_order_item(order_id: str, order_item_id: str, db: DBSession):
...
async def update_order_item(order_id: str, order_item_id: str, order_item_data: order_item_schema.OrderItemSchema, db: DBSession):
...
async def delete_order_item(order_id: str, order_item_id: str, db: DBSession):
